...
![screenshot_1](img/DeskDock/DeskDock_Screenshot_1_270x600.jpg)
![screenshot_2](img/DeskDock/DeskDock_Screenshot_2_270x600.jpg)
...
![Screenshot_3](img/DeskDock/DeskDock_Screenshot_3.png)
...
![Screenshot_4](img/DeskDock/DeskDock_Screenshot_4.png)

### DeskDock Android 端更多设置

在 Android（被控制） 端也是有更多的设置可供调节的，如：**光标大小、光标速度、物理键盘输入控制**等等，我主要就是用来控制和输入就足够了，并没有研究太多的设置，这方面有兴趣的用户可自行尝试。

![screenshot_5](img/DeskDock/DeskDock_Screenshot_5_270x600.jpg)
![screenshot_6](img/DeskDock/DeskDock_Screenshot_6_270x600.jpg)
